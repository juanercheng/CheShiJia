        ...
        $page.methods = {
            ...
            getCarAjax:function(){
                $.ajax({
                    cache: "False",
                    type: "POST", //提交方式
                    url: root_path + "recommend/getMarketFParamList",
                    data: {
                        token: sessionStorage.getItem("token"),
                        id: imgId,
                        page: 1,
